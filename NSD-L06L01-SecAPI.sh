...
# pull files from github, prepare nginx host and copy files to nginx host
    ...
    sudo scp /tmp/nsd_files/L6-L1-SecAPI/api_server.conf nginx:/etc/nginx/conf.d/api_server.conf
    sudo scp /tmp/nsd_files/L6-L1-SecAPI/juice.conf nginx:/etc/nginx/conf.d/juice.conf
    sudo scp /tmp/nsd_files/L6-L1-SecAPI/nginx.conf nginx:/etc/nginx/nginx.conf
    sudo scp /tmp/nsd_files/L6-L1-SecAPI/ssl-params.conf nginx:/etc/nginx/ssl-configs/ssl-params.conf
